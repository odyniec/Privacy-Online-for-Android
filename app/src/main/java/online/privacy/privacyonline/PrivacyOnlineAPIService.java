...
public class PrivacyOnlineAPIService extends IntentService {
    ...
    private void handleActionVerifyUserAccount(String username, String password) {
        Log.i(LOG_TAG_API_SERVICE, "Handler executed.");
        ...
        broadcastBooleanResult(checkResult);
    }

    private void broadcastBooleanResult(boolean checkResult) {
        Log.i(LOG_TAG_API_SERVICE, "Broadcasting response.");
        Intent broadcastIntent = new Intent();
        broadcastIntent.setAction(SetupActivity.LoginDetailsCheckReceiver.ACTION_REPONSE);
